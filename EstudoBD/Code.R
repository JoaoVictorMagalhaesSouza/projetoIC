...
setorMonitorado = "FINANCEIRO E OUTROS"
...
########################################################
#Serie temporal de algumas acoes de um setor
########################################################
...
#####################################################
#Parte de seleção de um bimestre(COMPLEMENTAR):
#####################################################
dadosBimestre <- function(DF,BancoDeDados_Acoes,bimestre){
...
dadosBimestre(DF,BancoDeDados_Acoes,1)
